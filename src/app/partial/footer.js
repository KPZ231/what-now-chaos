                ...
                <div className="container mx-auto">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                        ...
                        <div className="flex items-center gap-4">
                            <Link href="https://www.facebook.com/KPZsProductions" target="_blank" className="hover:opacity-80 transition-opacity">
                            ...
                            <Link href="https://www.instagram.com/KPZsProductions" target="_blank" className="hover:opacity-80 transition-opacity">
                                <div className="w-8 h-8 rounded-full bg-[var(--container-color)] flex items-center justify-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-[var(--text-gray)]" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <Link href="https://www.linkedin.com/in/kacper-duda-282150224" target="_blank" className="hover:opacity-80 transition-opacity">
                                <div className="w-8 h-8 rounded-full bg-[var(--container-color)] flex items-center justify-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-[var(--text-gray)]" viewBox="0 0 24 24" fill="currentColor">
